...
var pepper_pickup_scene = preload("res://pepper_pickup.tscn")
...
func _ready():
	...
	enemy_attack_sound.stream = load("res://assets/Audio Pack/enemy_attack_2.mp3")
	
	add_child(enemy_death_sound)
	enemy_death_sound.stream = load("res://assets/Audio Pack/enemy_death_sound_2.mp3")
...
func spawn_pepper_pickup():
	...
	var pepper = pepper_pickup_scene.instantiate()
	ui_layer.add_child(pepper)
	
	pepper.set_start_position(global_position, camera)
